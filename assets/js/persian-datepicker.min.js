...
var API = function () {
     ...
     * @example var pd = jQuery('.selector').persianDatepicker();
...
(function ($) {
    ...
    jQuery.fn.persianDatepicker = jQuery.fn.pDatepicker = function (options) {
        var args = Array.prototype.slice.call(arguments),
            output = null,
            self = this;
        if (!this) {
            jQuery.error('Invalid selector');
        }
        jQuery(this).each(function () {
            // encapsulation Args
            var emptyArr = [],
                tempArg = args.concat(emptyArr),
                dp = jQuery(this).data('datepicker'),
                funcName = null;
        ...
        jQuery(this).data('datepicker', self.pDatePicker);
...
var Input = function () {
    ...
    _createClass(Input, [{
        ...
        value: function observe() {
            ...
            //         let newDate = new Date(jQuery(this).val());
        ...
        value: function _attachInputElementEvents() {
            ...
            jQuery(this.elem).on('keydown', Helper.debounce(function (evt) {
                if (evt.which === 9) {
                    that.model.api.hide();
                    return false;
                }
